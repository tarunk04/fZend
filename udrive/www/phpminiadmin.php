...
.frm{border:1px solid #999999;background-color:#eeeeee;padding:10px}
...
<table class="frm">
<tr><td>User name:</td> <td><input type="text" name="v[user]" value="<?php echo $DB['user']?>"></td></tr>
<tr><td>Password:</td><td> <input type="password" name="v[pwd]" value=""></td></tr>
<tr><td>MySQL host:</td><td><input type="text" name="v[host]" value="<?php echo $DB['host']?>"> port: <input type="text" name="v[port]" value="<?php echo $DB['port']?>" size="4"></td></tr>
<tr><td>DB name:</td><td> <input type="text" name="v[db]" value="<?php echo $DB['db']?>"></td></tr>
<tr><td>Charset:</td><td> <select name="v[chset]"><option value="">- default -</option><?php echo chset_select($DB['chset'])?></select></td></tr>
<tr><td colspan="2" >
